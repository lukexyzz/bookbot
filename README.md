...
have a books/ file with text of different books inside 
USE COMMAND IN TERMINAL FOR BOOKS: 
...
Usage inside terminal (while in repo path) : python3 main.py <path_to_book> 
